...
public class ConferenceListAdapter extends BaseAdapter implements Filterable {
    ...
    com.worldline.sdco.techforumgradle.conference.ConferenceFinder conferenceFinder;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            ...
            conferenceItemView = (ConferenceListItemView) inflater.inflate(parent.getRootView().getId(), null);
            // codez bruno
			//conferenceItemView = ConferenceListItemView.build(context);
		} else {
